    ...
    return (
        <div className={ ArticleStyles.container }>
          ...
          <p className={ ArticleStyles.textContainer }>
            ...
            <br/><a className={ ArticleStyles.link } href="https://twitter.com/lostgoblin">@lostgoblin</a>
          </p>
          ...
          <p className={ ArticleStyles.textContainer }>
            Right in the beginning I started with researching a lot of tribal cultural huts and buildings as well as concept art for fantasy tribal races such as orcs and trolls and obviously goblins from other franchises such as Warcraft, Warhammer, Lord of the Rings etc but also more simple and colourful styles found in Dofus and concepts for low poly style buildings. My inspiration board is <a className={ ArticleStyles.link } href="https://nz.pinterest.com/gustavseymore/building-refs/">here</a> and <a className={ ArticleStyles.link } href="https://nz.pinterest.com/gustavseymore/goblin-homes/">here</a>
          </p>
          ...
          <p className={ ArticleStyles.textContainer }>
            <a className={ ArticleStyles.link } href="http://www.geeknative.com/44964/art-jonathan-kirtz/">Jonathan Kirtz</a>
          </p>
          <div className={ ArticleStyles.imageContainer }>
            <img className={ ArticleStyles.textImage } src="./content/images/article_5_7_16/seaver-liu-smithy-v006b.jpg"/>     
          </div>
          <p className={ ArticleStyles.textContainer }>
            <a className={ ArticleStyles.link } href="https://www.artstation.com/artwork/egkQ6">Seaver Liu</a>
          </p>
          <div className={ ArticleStyles.imageContainer }>
            <img className={ ArticleStyles.textImage } src="./content/images/article_5_7_16/Dofus_ConceptArts_BlackLiliPute_2.jpg"/>     
          </div>
          <p className={ ArticleStyles.textContainer }>
            <a className={ ArticleStyles.link } href="http://www.theconceptartblog.com/2014/08/10/artes-de-etienne-corbaurx-para-o-game-dofus/">Etienne Corbaurx</a>
          </p>
          <p className={ ArticleStyles.textContainer }>
            I also really loved these concepts I found on pinterest by this artist <a className={ ArticleStyles.link } href="https://www.behance.net/mazarat">Azamat Khairov</a>
          </p>
          <div className={ ArticleStyles.imageContainer }>
          ...
          <p className={ ArticleStyles.textContainer }>
            <a className={ ArticleStyles.link } href="https://www.behance.net/gallery/19364091/Little-house">Little House</a>
          </p>
          <p className={ ArticleStyles.textContainer }>
          ...
          <p className={ ArticleStyles.textContainer }>
            And then decided this one was the best to start with was a take on this lovely concept by <a className={ ArticleStyles.link } href="http://drawcrowd.com/projects/8b1ae8f4ca1bd46bec0e3e8dfbab7e2af8c6eaa3">Stoyan Stoyanov</a> as a reference:
          </p>
          <div className={ ArticleStyles.imageContainer }>
          ...
          <p className={ ArticleStyles.textContainer }>
            So the pathway system (which was explained in an <a className={ ArticleStyles.link } href="http://www.lostgoblin.com/blog?id=fork_in_the_road">earlier post</a>) was really important to be part of the building's aesthetic
          </p>
          <p className={ ArticleStyles.textContainer }>
